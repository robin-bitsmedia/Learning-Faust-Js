 ...
 * Slug: corporatecrafter/archive-product
...
<div class="wp-block-group alignwide"><!-- wp:woocommerce/breadcrumbs {"textColor":"contrast","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}}} /--></div>
<!-- /wp:group --></div></main>
<!-- /wp:cover -->
...
<!-- wp:post-title {"textAlign":"center","isLink":true,"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|10"}},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"500"}},"__woocommerceNamespace":"woocommerce/product-query/product-title"} /-->
...
<!-- wp:paragraph -->
<p>
  <?php echo esc_html__( 'No products were found matching your selection. ', 'corporatecrafter' ); ?> </p>
<!-- /wp:paragraph -->
